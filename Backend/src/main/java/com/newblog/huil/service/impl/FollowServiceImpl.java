...
public class FollowServiceImpl implements FollowService {
    ...
    public List<Map<String, Object>> findFollowees(int userId, int offset, int limit) {
        String followeeKey = RedisKeyUtil.getFolloweeKey(userId, NewBlogConstant.ENTITY_TYPE_USER);
        ...
        for (Integer targetId : targetIds) {
            ...
            User tempUser = userService.findByUserId(targetId);
            if (CheckUserUtil.UserIsNull(tempUser)) {
                continue;
            }
    ...
    public List<Map<String, Object>> findFollowers(int userId, int offset, int limit) {
        String followerKey = RedisKeyUtil.getFollowerKey(NewBlogConstant.ENTITY_TYPE_USER, userId);
